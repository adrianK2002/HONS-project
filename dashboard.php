...
if ($userId !== null) {
    $search_results = mysqli_query($link, "
        ...
        GROUP BY portfolio_name.createdBy={$_SESSION['id']}
    ");
} else {
...
<body>
	...
	<!-- //navbar -->
	<?php 
    // Fetch one row from the search_results
    $portfolio = mysqli_fetch_assoc($search_results);
    ...
    <?php 
    endif; // End of check for $portfolio
    ?>
</body>